 ...
 */
final class Version20260504201415 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, invoice_number VARCHAR(15) NOT NULL, invoice_date DATETIME NOT NULL, due_date DATETIME NOT NULL, subtotal NUMERIC(10, 2) NOT NULL, tax_amount NUMERIC(10, 2) NOT NULL, total_amount NUMERIC(10, 2) NOT NULL, status VARCHAR(20) NOT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, patient_id INT DEFAULT NULL, created_by_id INT DEFAULT NULL, INDEX IDX_906517446B899279 (patient_id), INDEX IDX_90651744B03A8386 (created_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE invoice_item (id INT AUTO_INCREMENT NOT NULL, description LONGTEXT DEFAULT NULL, unit_price NUMERIC(10, 2) NOT NULL, total NUMERIC(10, 2) NOT NULL, insurance_covered_amount NUMERIC(10, 2) NOT NULL, patient_payable_amount NUMERIC(10, 2) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, patient_service_id INT DEFAULT NULL, service_id INT DEFAULT NULL, invoice_id INT DEFAULT NULL, INDEX IDX_1DDE477B5B9C0F09 (patient_service_id), INDEX IDX_1DDE477BED5CA9E6 (service_id), INDEX IDX_1DDE477B2989F1FD (invoice_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE patient_service (id INT AUTO_INCREMENT NOT NULL, perfomed_at DATETIME NOT NULL, notes LONGTEXT DEFAULT NULL, unit_price NUMERIC(10, 2) NOT NULL, total_amount NUMERIC(10, 2) NOT NULL, has_insurance TINYINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, patient_id INT DEFAULT NULL, service_id INT DEFAULT NULL, user_id INT DEFAULT NULL, INDEX IDX_BCFECF396B899279 (patient_id), INDEX IDX_BCFECF39ED5CA9E6 (service_id), INDEX IDX_BCFECF39A76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE payment (id INT AUTO_INCREMENT NOT NULL, amount NUMERIC(10, 2) NOT NULL, payment_method VARCHAR(20) NOT NULL, paid_by VARCHAR(10) NOT NULL, transaction_reference VARCHAR(15) NOT NULL, paid_at DATETIME NOT NULL, notes LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, invoice_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_6D28840D2989F1FD (invoice_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE service (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, code VARCHAR(50) NOT NULL, description LONGTEXT DEFAULT NULL, price INT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('ALTER TABLE invoice_item ADD CONSTRAINT FK_1DDE477B5B9C0F09 FOREIGN KEY (patient_service_id) REFERENCES patient_service (id)');
        ...
        $this->addSql('ALTER TABLE patient_service ADD CONSTRAINT FK_BCFECF396B899279 FOREIGN KEY (patient_id) REFERENCES patient (id)');
        $this->addSql('ALTER TABLE patient_service ADD CONSTRAINT FK_BCFECF39ED5CA9E6 FOREIGN KEY (service_id) REFERENCES service (id)');
        $this->addSql('ALTER TABLE patient_service ADD CONSTRAINT FK_BCFECF39A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invoice_item DROP FOREIGN KEY FK_1DDE477B5B9C0F09');
        ...
        $this->addSql('ALTER TABLE patient_service DROP FOREIGN KEY FK_BCFECF39A76ED395');
